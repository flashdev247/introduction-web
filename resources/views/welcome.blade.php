...
<body style="margin: 0; padding: 0; font-family: 'Instrument Sans', ui-sans-serif, system-ui, sans-serif; background-color: #fefdfb; color: #1b1b18;">
    <!-- Header -->
    <header style="border-bottom: 1px solid #e0e0dd; background-color: white; position: sticky; top: 0; z-index: 50;">
        <div style="max-width: 1280px; margin: 0 auto; padding: 24px 32px; display: flex; align-items: center; justify-content: space-between;">
            ...
            <!-- Title Center -->
            <div style="position: absolute; left: 50%; transform: translateX(-50%); font-size: 20px; font-weight: 600;">Your Site Title</div>

            <!-- Social Icons Right -->
            <div style="display: flex; align-items: center; gap: 24px; margin-left: auto;">
                <a href="#" title="Instagram" style="color: #706f6c; text-decoration: none; display: flex; align-items: center; justify-content: center; transition: color 0.2s;">
                ...
                <a href="#" title="Twitter" style="color: #706f6c; text-decoration: none; display: flex; align-items: center; justify-content: center; transition: color 0.2s;">
                    <svg style="width: 20px; height: 20px;" fill="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Main Content -->
    <main style="max-width: 1280px; margin: 0 auto; padding: 80px 32px; display: flex; align-items: center; justify-content: space-between; gap: 60px;">
        <!-- Left Section - Text -->
        <div style="flex: 1;">
            <h2 style="font-size: 48px; font-weight: 600; line-height: 1.2; margin-bottom: 32px; color: #1b1b18;">Explore Our<br />Packages</h2>
            <p style="font-size: 18px; color: #706f6c; line-height: 1.6;">Discover our premium selection of packages designed to meet your needs.</p>
        </div>

        <!-- Right Section - Image -->
        <div style="flex: 1; display: flex; justify-content: flex-end;">
            <img src="https://images.unsplash.com/photo-1565636192335-14c46fa1120d?w=500&h=600&fit=crop" alt="Lamp with flower" style="max-width: 100%; height: auto; border-radius: 12px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); max-height: 500px; object-fit: cover;">
        </div>
    </main>
